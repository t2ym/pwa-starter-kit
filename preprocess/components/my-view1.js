...
class MyView1 extends PageViewElement {
  ...
  render() {
    return html([
      ...
      'meta': {},
      'model': {},
      'section_1:h2': 'Static page',
      'section_1:p_1': 'This is a text-only page.',
      'section_1:p_2': 'It doesn\'t do anything other than display some static text.',
      'section_2:h2': 'Welcome',
